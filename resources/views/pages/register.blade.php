...
@endif
<!--Last Name ******************-->
<!--<a href="{{route('user_login')}}" class="btn btn-success">Login</a>-->
<a href="{{route('user_login')}}" class="login_btn"><input type="button"  class="login action-button" value="Login" /></a>
...
<div class="form-group{{ $errors->has('captcha') ? ' has-error' : '' }} input-group">
<span class="input-group-addon"><i class="fa fa-key"></i>
</span>
<input type="text"  name="captcha" id="captcha" class="form-control input-md text_field" placeholder="captcha" tabindex="4"tabindex="5" value="{{ old('captcha') }}"  required>
</div>
